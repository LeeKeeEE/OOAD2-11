...
curl -T target/site/surefire.html $1/test/unit-test/$TIME/core/test-result/core-test.html -u mingqiu:$2
curl -T ../core.log $1/test/unit-test/$TIME/core/test-result/core.log -u mingqiu:$2
...
do
  ...
  curl -T target/site/surefire.html $1/test/unit-test/$TIME/$M/test-result/$M-test.html -u mingqiu:$2
  curl -T $M.log $1/test/unit-test/$TIME/$M/test-result/$M.log -u mingqiu:$2
