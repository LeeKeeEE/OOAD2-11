...
public class AccountDao {
     ...
     * @param pageSize 页大小
     */
    public List<Account> retrieveByShopId(Long shopId, Integer page, Integer pageSize){
        ...
        if (!Objects.isNull(accountIds)) {
            ...
            List<Account> accountList = this.retrieve(accountPoExample, page, pageSize);
    ...
    public List<Account> retrieveByShopId(Long shopId) {
        ...
        criteria.andShopIdEqualTo(shopId);
        return retrieve(example, 1, MAX_RETURN);
    }
}
