...
public class ChannelService {
    ...
    public List<Account> retrieveValidAccount(Long shopId, Integer page, Integer pageSize){
        ...
        List<Account> accounts = this.accountDao.retrieveByShopId(shopId, page, pageSize);
    ...
    public List<Account> retrieveAccount(Long shopId, Integer page, Integer pageSize) {
        List<Account> accountList = this.accountDao.retrieveByShopId(shopId, page, pageSize);
        return accountList;
    }
